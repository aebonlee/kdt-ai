export const exams = {
  ...
  'transformer': {
    ...
    notes: [
      '실습 1은 개인 과제, 실습 2는 3인 1팀 과제로 진행한다.',
  ...
  'prompt': {
    ...
    notes: [
      '두 번째 실습은 3인 1팀 과제로 진행한다(임성열 정본 기준). 다만 실습교수별로 팀 인원이 달라 하만석 강사안은 2인 1조, 박영웅 강사안은 개인 실습으로 운영한다 — 반별 안내를 우선한다.',
...
// ── 타 강사판 평가안(참고 병기) — 2026-07-14 수령 종합실습평가 xlsx 근거 ──
