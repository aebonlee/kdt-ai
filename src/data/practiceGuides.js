...
export const practiceGuides = {
  ...
  transformer2: {
    ...
    groups: [
      ...
      {
        h: '■ 실습2 팀 편성 — 확정 (좌석표 기반, 어제와 동일)',
        note: '규칙: 6인석은 3+3, 4인석은 4인 한 팀.\n아래 편성으로 진행하되, 조정이 필요하면 슬랙 팀 과제 안내글에 댓글로 알려주세요 — 조율 후 확정합니다.',
        items: [
          '1조 → 1-A(정민규·박현송·이서현) / 1-B(고동민·윤찬웅·원광식)',
          '2조 → 2-A(정유은·박희태·이홍규) / 2-B(김다은·박세호·윤희재)',
          '3조 → 3-A(이경현·황윤희·양시온·윤민섭 + 고창인) [4~5명]',
          '4조 → 4-A(김규현·양경환·천성훈) / 4-B(김민아·신준엽·윤신혜)',
          '5조 → 5-A(김영환·이현무·문준석) / 5-B(박나원·정유경·최장우)',
          '6조 → 6-A(박세현·손기훈·유승헌·한예빈) [4명]',
        ],
      },
    ],
