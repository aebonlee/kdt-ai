...
export const details = {
  ...
  "transformer2-1": {
    ...
    "homework": [
      "개인 보고서(1페이지): LSTM vs GPT-2 생성 비교 + 차이의 이유(장기 의존성·Self-Attention) — 오늘 밤 12시 정각 전(24:00) 슬랙 2반 제출",
  ...
  "transformer2-2": {
    ...
    "homework": [
      "팀 과제: 에이전트 구현 코드 + 서비스 시나리오 발표자료(최소 3p) — 7.24(금) 팀별 발표 후, 밤 12시 정각 전(24:00)까지 슬랙 2반 제출",
