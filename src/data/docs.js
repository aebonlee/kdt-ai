...
export const docsGroups = [
  ...
  {
    id: "tt0714",
    title: "[0714] 강사 반별 시간표",
    desc: "18개반 확정 시간표(260710)와 판교 4층 회차별 시간표 양식",
    folder: "https://drive.google.com/drive/folders/1rIvU_DJQuRv41WKaZ6IikNg72c3zqlTC",
    files: [
      { t: "★ 4기 강사 반별 시간표_F (260710 확정본)", id: "1j2ZQmGtyfrOhtksBMJmBm93xF8JIPHLG", x: "xlsx", b: 154637, d: "2026-07-14" },
      { t: "[SK+AX] KDT AI 캠퍼스 시간표 양식(판교 4층) 1-5회차", id: "1adppM5Xzjk9z2G-hfCkzaqRvB4GIC2kX", x: "xlsx", b: 33440, d: "2026-07-14" },
    ],
  },
  {
    id: "syl0714",
    title: "[0714] Syllabus 신규·갱신분",
    desc: "7/14 수령 실라버스 중 기존 드라이브에 없던 신규·갱신 11건",
    folder: "https://drive.google.com/drive/folders/1ALGoG-sWwEqY5sPaAIxqxD7WzdGwJJCl",
    files: [
      { t: "1)Full-stack_1. Git 이해활용 · 교재 (백정열)", id: "1nw51yKNzI6hDLcLg9lTK_TVpiWaLipZ-", x: "pdf", b: 6803923, d: "2026-07-14" },
      { t: "1)Full-stack_1. Git 이해활용 실습예제코드 (백정열)", id: "1Nfr360ud2KI3t2anvtPuJTTeJBSu8DGb", x: "zip", b: 27438, d: "2026-07-14" },
      { t: "1)Full-stack_1. Git 이해활용 (정윤석)", id: "14uBQQ4C-szkLPu6eYXj1zvcHpx7gDhY6", x: "pptx", b: 32351, d: "2026-07-14" },
      { t: "1)Full-stack_4. 스마트 데이터 교육생배포용 (최진철·울산B)", id: "1n3mhXQY-kohgkXbc0pbgz_AOLV5f8dkD", x: "pdf", b: 124833, d: "2026-07-14" },
      { t: "1)Full-stack_5. Java·SpringBoot·REST API (임성열)", id: "16wAfMTn1ApZYW18Iiz14xowDZFgR3RVd", x: "pptx", b: 88328, d: "2026-07-14" },
      { t: "2)데이터·AI Ops_4. 머신러닝·딥러닝 이해 (배기주)", id: "1b1Lx0jM8_Xm9gK1Q-02tGPQ7eN027qYJ", x: "pdf", b: 169934, d: "2026-07-14" },
      { t: "3)Cloud_2. 컨테이너 이해·컨테이너화 (백정열)", id: "1pI2b3F_8D4z6kQwiXeMLXIKe41tzxsND", x: "pptx", b: 37848, d: "2026-07-14" },
      { t: "4)생성형AI_4. VectorDB 기존 (백정열)", id: "1Tmkk8rBqLzn6wzljD9Z-b950Lqpc5Azt", x: "pptx", b: 65675, d: "2026-07-14" },
      { t: "4)생성형AI_8. AI Agent Capstone (배기주)", id: "1LfDyIkBJlLx21KYMcCrMG1LpFViuuq05", x: "pptx", b: 164702, d: "2026-07-14" },
      { t: "4)생성형AI_8. AI Agent Capstone (정윤석)", id: "1_PCHmzjGILnMQNRnYQxqH1P56snfc6Z4", x: "pptx", b: 166745, d: "2026-07-14" },
      { t: "Mini-project ① AI 웹 서비스 설계 (백정열)", id: "1nzAxqIp4cPeyT6P5qUMwlXJgTrDont_D", x: "pptx", b: 58836, d: "2026-07-14" },
    ],
  },
  {
    id: "eval0714",
    title: "[0714] 종합실습평가 신규분",
    desc: "7/14 수령 평가양식 중 신규 17건 — 임성열·백정열·박병선·이은호·최진철판",
    folder: "https://drive.google.com/drive/folders/1Ad3hU4yqxEJD6wETE-9h0MTZeiL0iYWY",
    files: [
      { t: "평가_Prompt 설계와 Context (임성열)", id: "1NgedtT1Pke_72P6zpXoPZafAP9SfPBEO", x: "xlsx", b: 36165, d: "2026-07-14" },
      { t: "평가_Agile 방법론·MSA 개발 (임성열)", id: "1rawOALhCqBxnpxz8jpW2kHSUvZGOg5X_", x: "xlsx", b: 36174, d: "2026-07-14" },
      { t: "평가_LLM과 Transformer 아키텍처 (임성열)", id: "1izzqkmhRsK7eGQMbD_NBvbpWB2_2S4hD", x: "xlsx", b: 86404, d: "2026-07-14" },
      { t: "평가_sLLM·Fine Tuning (임성열)", id: "1gmFM5KfdUOh8IJYbWoPNBUPAGYDV4UHD", x: "xlsx", b: 85807, d: "2026-07-14" },
      { t: "평가_Java·SpringBoot·Rest API 구현 (임성열)", id: "12axiIHk2gWQps8g45nuJ9PgbZqkZYo32", x: "xlsx", b: 85940, d: "2026-07-14" },
      { t: "평가_파이썬 (백정열)", id: "1zWHAZ4ondzZT7efhaJumlOpgmdTPa4aD", x: "xlsx", b: 87420, d: "2026-07-14" },
      { t: "평가_VectorDB (백정열)", id: "1Mm898NK_RLfrAXhmwN_hfMVyFI-Txmc_", x: "xlsx", b: 86119, d: "2026-07-14" },
      { t: "평가_스마트 데이터 이해·활용 (백정열)", id: "189LweUCh-gH2-zKJiC4wkiMWzcUfPREq", x: "xlsx", b: 88062, d: "2026-07-14" },
      { t: "평가_컨테이너 이해·컨테이너화 (백정열)", id: "1-BbVoFDuZrP7YJcv3h1aU5y5Hv_7oCY9", x: "xlsx", b: 86035, d: "2026-07-14" },
      { t: "평가_AI 웹서비스 설계 Mini-project (백정열)", id: "1SALc3EZtflXLO0TZ71NFwMID9buwmv-N", x: "xlsx", b: 85989, d: "2026-07-14" },
      { t: "평가_A1. Prompt·Context Engineering (박병선)", id: "1bjZCgmx6UaUG5XZOVzgHBpRRlb9l7BS4", x: "xlsx", b: 58271, d: "2026-07-14" },
      { t: "평가_A2. LLM·Transformer 아키텍처 (박병선)", id: "1wwTiA2eksmwEeKIvpdjdgXt4-Z0KsfGK", x: "xlsx", b: 98368, d: "2026-07-14" },
      { t: "평가_D2. 데이터 분석 개요·기초통계 (박병선)", id: "1ezKHop8BozlZ5aD0Yxh84NA0aHLXlEj8", x: "xlsx", b: 58022, d: "2026-07-14" },
      { t: "평가_Feature Engineering (이은호)", id: "1YVq3x_A77Ktkl-xJKRnGTiEY_S3vzJm9", x: "xlsx", b: 90270, d: "2026-07-14" },
      { t: "평가_데이터분석개요·기초통계 (이은호)", id: "14MwLo4DmeepQmO8k66xYp6GL9WyH3mMO", x: "xlsx", b: 95644, d: "2026-07-14" },
      { t: "평가기준 종합실습평가표 강사용 (최진철·울산O)", id: "1t0Mn8IjjAhxWfn4UHHez-C1VSc4umkQx", x: "xlsx", b: 281147, d: "2026-07-14" },
      { t: "평가기준 교육생배포용 (최진철·울산P)", id: "1S7E3u2zRFtV-_NS09wyTwuDEmrNM61OE", x: "pdf", b: 1370691, d: "2026-07-14" },
    ],
  },
  {
    id: "tb0714",
    title: "[0714] 4기 교육생 교재 (PDF)",
    desc: "7/14 수령 교육생 교재 PDF 19종 — 과목별 최신 배포본",
    folder: "https://drive.google.com/drive/folders/1IH1CjeHJLvD-APr9tWDiIS4xz5C4Qdxf",
    files: [
      { t: "1)Full-stack_1. Git 이해활용 (백정열)", id: "1RU7mL5Z5sf4uPzVaFJlr5UTOkMEXQ7Su", x: "pdf", b: 6803923, d: "2026-07-14" },
      { t: "1)Full-stack_1. Git 이해활용 (강병호·0709)", id: "14QAWmHZkfH9IlbCYxeaRC-i-c6-ZHYU8", x: "pdf", b: 9471948, d: "2026-07-14" },
      { t: "1)Full-stack_1. Git 이해활용 (권기창)", id: "1J6wbgCYedUVr7Ch0ulYyLLwWIt_-q9ae", x: "pdf", b: 2681028, d: "2026-07-14" },
      { t: "1)Full-stack_2. HTML·CSS·JavaScript (강병호·0713)", id: "1sN0Ze1HmpTkZ7T7J9qwLIw2gVHJ3KiyQ", x: "pdf", b: 10896278, d: "2026-07-14" },
      { t: "1)Full-stack_3. Frontend Vue.js (강병호·0630)", id: "1byndSv6lWL8vwJs7j_aTXSsAMV-pwDTj", x: "pdf", b: 10137057, d: "2026-07-14" },
      { t: "1)Full-stack_4. 스마트 데이터 (백정열·AI캠퍼스 4일)", id: "1y2wpWF08SXPM6nAL1ANj-Xl4M1J4wAGW", x: "pdf", b: 45011427, d: "2026-07-14" },
      { t: "1)Full-stack_4. 스마트 데이터 이론 (최진철·울산 3일)", id: "19YRS99fKaT8PtOLECefnwnMImvXusSgq", x: "pdf", b: 10776031, d: "2026-07-14" },
      { t: "1)Full-stack_4. 스마트 데이터 실습·과제 (최진철·울산 3일)", id: "1CdH6zqeXnXScPvPohZnfC_Kc0XAEjq0C", x: "pdf", b: 17296562, d: "2026-07-14" },
      { t: "1)Full-stack_4. 스마트 데이터 과정 안내 (최진철·울산 3일)", id: "15NrAFJOf5BvENXGPDX-E0WavgrriYxUH", x: "pdf", b: 1876300, d: "2026-07-14" },
      { t: "1)Full-stack_5. Java·SpringBoot·REST API (임성열)", id: "1nM125Kw8N0X6ioD3UbquilYcn9_PEnHQ", x: "pdf", b: 11959700, d: "2026-07-14" },
      { t: "2)데이터·AIOps_1. Python 이해 (백정열)", id: "1PzePSbEb6HX8WZmwUzSAQLceRVXPR07s", x: "pdf", b: 4410737, d: "2026-07-14" },
      { t: "2)데이터·AIOps_2. 기초통계 (배기주)", id: "1glWpbM6WufUqc9CFNAxVxc-qkIiWVWTV", x: "pdf", b: 5934513, d: "2026-07-14" },
      { t: "2)데이터·AIOps_2. 기초통계 (이은호)", id: "1enDwREOpVxvGr9Rq4JViT_AIqpmaonjd", x: "pdf", b: 8166481, d: "2026-07-14" },
      { t: "3)Cloud_1. Agile 방법론·MSA 개발 (임성열)", id: "1buqHpaGJn1DCw26wRH6eez_T3QEjHu2H", x: "pdf", b: 14774743, d: "2026-07-14" },
      { t: "3)Cloud_2. 컨테이너 이해·컨테이너화 (백정열)", id: "1ojTppefZQ-TLJjI1H8AVs0WxpZP3396c", x: "pdf", b: 10081555, d: "2026-07-14" },
      { t: "4)생성형AI_3. sLLM 구현·Fine Tuning (임성열)", id: "1e8zFjc6CvyrdYNwFEM_attXjLECZXKBl", x: "pdf", b: 4193709, d: "2026-07-14" },
      { t: "4)생성형AI_4. Vector DB (백정열)", id: "1zlyq9t2XoJ_a2sqv-MpqXboZlFSbj0Tq", x: "pdf", b: 8797141, d: "2026-07-14" },
      { t: "4)생성형AI_6. RAG Pipeline 설계·구축 (배기주)", id: "1Qx2HWFmjzke_GwJethA31awXdoXcXZWP", x: "pdf", b: 9261131, d: "2026-07-14" },
      { t: "4)생성형AI_7. AI Agent 설계·구축 (배기주)", id: "1YM1fFu5xPcxC3tbOesrUrxWHrS8Ud4Rc", x: "pdf", b: 8418526, d: "2026-07-14" },
    ],
  },
  {
    id: 'ori',
