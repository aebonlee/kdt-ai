...
export const theory = {
  ...
  "vue-4": {
    "theory": [
      ...
      {
        "h": "UI 라이브러리 Element Plus로 화면 생산성 높이기 (교재 8장)",
      ...
      {
        "h": "Modern JavaScript(ES6+) 핵심 문법 — Vue 코드가 이렇게 짧은 이유 (교재 9장)",
      ...
      {
        "h": "ESLint·Prettier로 코드 품질 지키기 (교재 10장 Vite 빌드 및 실무 배포)",
