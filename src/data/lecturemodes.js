...
export const modes = {
  ...
  'transformer2-1': { tag: '이론+실습', ratio: '이론 50% · 실습 50%', note: '오전 이론(토큰화·Attention) 후 실습1: LSTM vs Transformer 문장 생성 비교' },
  'transformer2-2': { tag: '종합실습', ratio: '이론 35% · 실습 65%', note: '실습2: CrewAI 에이전트 팀 개발 + 서비스 시나리오 발표·평가' },
...
export const periodModes = {
  ...
  'transformer2-1': ['이론', '이론', '이론', '이론', '실습', '실습', '실습', '실습'],
  'transformer2-2': ['이론', '이론', '실습', '실습', '실습', '실습', '실습', '종합실습'],
