...
const RESOURCES = [
  ...
  { t: '실습교안 (웹·PDF)', d: '전 과목 실습 교재를 한 문서로 묶은 교안입니다. 좌측 과목 메뉴로 이동하고, 코드 복사·줄바꿈 전환·과목 단위 인쇄를 지원합니다.', to: '/textbook' },
  { t: '선수학습자료', d: '파이썬·Git·CLI·SQL·Docker 등 기초 19주제. 과정을 따라가기 벅찰 때 먼저 볼 자료입니다.', to: '/prep' },
  { t: '팀 프로젝트', d: '11월 팀 프로젝트의 기획부터 발표까지 전 과정 가이드입니다. 종합 성과를 준비할 때 활용하세요.', to: '/team' },
