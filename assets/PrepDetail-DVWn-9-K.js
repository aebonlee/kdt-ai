import{j as e}from"./index-BnG782ru.js";import{f as j,g as _,L as n}from"./react-vendor-DkQmGj46.js";import{a as R,p as o}from"./resources-BliqnJQH.js";import{R as b}from"./Rating-J5p8t_lI.js";import{C as v}from"./CodeBlock-hnIf9Yut.js";import{R as l}from"./Rich-B5NHg7Hq.js";import"./supabase-x7pv8hHy.js";const P={python:{overview:"Python은 동적 타입·인터프리터 언어로 가독성과 풍부한 생태계가 강점이다. AI 실습에서는 표준 라이브러리와 NumPy/Pandas 같은 과학 스택, 가상환경 기반 의존성 관리가 핵심 기본기다.",advanced:[{h:"데이터 모델·이터러블",items:["이터레이터/제너레이터(yield)로 지연 평가","comprehension·generator expression","collections(Counter·defaultdict·deque)","__iter__/__next__·컨텍스트 매니저(with)"]},{h:"실무 품질",items:["타입 힌트(typing)와 mypy","데코레이터로 횡단 관심사(로깅·캐싱)","logging 모듈(print 대신)","pytest 단위 테스트"]}],examples:[{title:"제너레이터로 대용량 파일 메모리 효율 처리",lang:"python",code:`def read_large(path):
